...
public class NPCPathFinder extends Thread {
	...
	if (node.xPos != parent.xPos && node.zPos != parent.zPos) {
	    ...
	    corner = node.yPos > parent.yPos ? !getNode(parent.b.getRelative(0, 2, 0)).notsolid : !getNode(node.b
		    .getRelative(0, 2, 0)).notsolid;
	}
	...
	return !corner
		&& (node.notsolid && (!nodeBelow.notsolid || nodeBelow.liquid && node.liquid) && nodeAbove.notsolid || node == endNode);
    }
